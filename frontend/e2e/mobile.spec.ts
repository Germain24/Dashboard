...
test("@smoke navigation Finance utilisable sur mobile sans débordement", async ({ page }) => {
...
test("@live l'estimation fiscale reste lisible sur mobile", async ({ page }, testInfo) => {
  await page.goto("/finance");
...
test("@live les transactions sont paginées et contenues sur mobile", async ({ page }) => {
  await page.goto("/finance");

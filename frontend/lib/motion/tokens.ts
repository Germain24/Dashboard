...
export const durations = {
  ...
  base: 0.45,
  slow: 0.7,
  /** Sortie de module : assez brève pour que la navigation reste réactive. */
  routeExit: 0.18,
  /** Entrée de module : déplacement de caméra doux, sans dépasser 800 ms au total. */
  routeEnter: 0.62,
} as const;
...
/** Mouvement de caméra symétrique, inspiré des transitions cinématiques. */
export const EASE_CAMERA: [number, number, number, number] = [0.65, 0, 0.35, 1];

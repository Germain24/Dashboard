...
export const MODULES: Module[] = [
  ...
  },
  {
    slug: "score",
    label: "Score",
    description: "Score de forme quotidien : sommeil, sport, nutrition (+ Journal de vie, Vue 360, Bilan).",
    icon: Gauge,
    group: "Exécution & Système",
    ready: true,
  },
  ...
  },
  {
    slug: "patrimoine",
    label: "Patrimoine",
    description: "Comptes multi-devises, actifs & passifs, patrimoine net.",
    icon: Landmark,
    group: "Finances & Ingénierie",
    ready: true,
  },

...
const getHint = () => (/Mac|iPhone|iPad|iPod/.test(navigator.userAgent) ? "⌘K" : "Ctrl K");
const getServerHint = () => null;

export function CommandTrigger() {
  const hint = useSyncExternalStore(noSubscribe, getHint, getServerHint);

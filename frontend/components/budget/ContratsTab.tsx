        ...
        {!showForm ? (
          ...
          <form onSubmit={onSubmit} className="flex flex-wrap items-end gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs text-[var(--muted-foreground)]">Nom</label>
              <input
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs text-[var(--muted-foreground)]">Catégorie</label>
              <select
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs text-[var(--muted-foreground)]">Montant</label>
              <input
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs text-[var(--muted-foreground)]">Périodicité</label>
              <select
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs text-[var(--muted-foreground)]">Échéance (optionnel)</label>
              <input

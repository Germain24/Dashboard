...
export function CashTaxPanel() {
  ...
  const plTotal = state.pl_total ?? state.pl_realise + state.pl_latent_total;
    ...
    <div className="grid gap-3 md:grid-cols-2">
      <section className="glass-card rounded-[var(--radius-lg)] p-4">
        ...
        <dl className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
          ...
          <Stat label="P&L total (réalisé + latent)" value={money(plTotal)} tone={plTotal >= 0 ? "positive" : "negative"} strong />
        </dl>

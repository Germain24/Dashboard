# Mission Control — Améliorations P0/P1 : navigation, design, performance (livré)

> Extrait de `orchestration/en-cours/improvements.md` le 2026-07-04 : §1
> (fluidité de navigation, P0), §2 (design Verre Clair, P1) et §4 (performance,
> P1) sont désormais 100% terminés. Déplacés ici pour ne pas mélanger le
> travail livré avec §3 (encore mixte) et §5/§6 (pas commencés, restés dans
> `en-cours/improvements.md` et `a-faire/ameliorations-p2-modules-qualite.md`).
>
> Contexte d'origine (généré le 2026-07-02) : audit ancré sur l'état réel du
> code (Next.js 15 App Router + FastAPI/SQLModel, 29 segments de route, design
> system « Verre Clair » dans DESIGN.md). Complète `orchestration/AMELIORATIONS_200.txt`
> (vue item par item) par une vue thématique : élever l'app existante, sans
> reconstruction ni mock data sur les modules qui ont déjà de vraies données.

Légende : [S] petit · [M] moyen · [L] gros — (\*) confort · (\*\*) valeur réelle · (\*\*\*) structurant

---

## 1. Fluidité de navigation — tuer l'effet « PowerPoint » (P0) — ✅ TERMINÉ
...
## 2. Design « quiet luxury » — combler l'écart avec Verre Clair (P1) — ✅ TERMINÉ

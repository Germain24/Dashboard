...
- **`a-faire/`** — specs/plans rédigés mais dont l'exécution n'a pas commencé.
  ...
  fichier), `ameliorations-vague2-backlog.txt` (items 256-500 de
  `AMELIORATIONS_200.txt`, backlog d'idées, trié par pertinence le 2026-07-20)
  et `2026-07-22-audit-complet-dashboard.md` (audit transversal en 8 segments —
  dépôt, données, tests/CI, shell, et un passage module par module — avec un
  backlog P0-P3 en fin de document ; toutes les mesures y sont reproductibles
  via l'annexe méthode).

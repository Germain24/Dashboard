"""Classement et génération musicale via l'API DeepSeek (compatible OpenAI).

DeepSeek expose un endpoint Chat Completions
...
def generate_text(prompt: str, *, model: str | None = None, _post=None) -> str:
    """Génération textuelle courte utilisée par les suggestions musicales."""
    if not is_configured() and _post is None:

"""Suggestions d'artistes/genres à explorer via DeepSeek."""
...
def suggest_artists(session: Session, ambiance: str, *, generate=None) -> list[str]:
    ...
    if not artists:
        return []
    generate = generate or deepseek_client.generate_text
    prompt = (

...
MEAL_TITLES = {"petit-déjeuner", "déjeuner", "dîner"}


def is_meal_event(event: dict[str, Any]) -> bool:
    """Repas retirés des vues Agenda : ils ne s'affichent ni ne bloquent."""
    return (event.get("titre") or "").strip().casefold() in MEAL_TITLES

...
def run(session) -> str | None:
    # Retourne None quand rien n'a été créé : le runner ne notifie alors pas
    # (cf. audit §3.E). Les rappels eux-mêmes restent des Notification créées
    # ci-dessous ; seule la notification « job terminé » à vide est supprimée.
    ...
    # Aucun rappel imminent : cas de très loin le plus fréquent (96 passages/jour).
    return None

...
@router.post("/patrimoine/external-accounts/refresh")
def refresh_external_accounts_now(session: Session = Depends(get_session)):
    """Force une synchronisation Kraken + MetaMask, sans exposer les secrets."""
    from app.services.finance.external_accounts import refresh_external_accounts

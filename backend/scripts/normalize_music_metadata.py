"""Normalise les métadonnées entre la bibliothèque Qobuz (FLAC, ~/Music) et
les téléchargements MP3 (~/Desktop/Musique Tele).
...
TELE_DIR = Path.home() / "Desktop" / "Musique Tele"

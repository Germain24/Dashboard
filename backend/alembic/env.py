"""Alembic env — branché sur SQLModel.metadata."""
...
# Permettre d'importer `app.*` quand alembic est lancé depuis backend/
BACKEND_DIR = Path(__file__).resolve().parent.parent
sys.path.insert(0, str(BACKEND_DIR))

# Charge l'app pour enregistrer toutes les tables sur SQLModel.metadata.
from app.core.config import settings  # noqa: E402
from app import models  # noqa: F401, E402  -- import side-effect
